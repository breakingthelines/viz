...
/**
 * The Pass Network's full user-selectable state, driven by its selector:
 ...
 * Seed it via {@link PassNetworkProps.initialSelection} and observe changes via
 * {@link PassNetworkProps.onSelectionChange}.
 */
export interface PassNetworkSelection {
...
export interface PassNetworkProps {
   ...
   */
  initialSelection?: PassNetworkSelection;
  /**
   ...
   */
  onSelectionChange?: (selection: PassNetworkSelection) => void;
}
...
export function PassNetwork({
  ...
  const [selection, setSelection] = usePersistedSelection<PassNetworkSelection>(
    initialSelection,
